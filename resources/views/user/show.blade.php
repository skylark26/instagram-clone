...
<div class="flex lg:flex-row flex-col items-center lg:py-8 lg:space-x-8">
    ...
    <div class="lg:w/8/12 flex-1 flex flex-col lg:items-start items-center">
        ...
        <p class="lg:text-left mb-2 text-center  dark:text-gray-100"> Nam liber tempor cum soluta nobis eleifend option
...
<div class="flex items-center justify-between mt-8 space-x-3">
    ...
    <div
        ...
        <a href="#" class="flex h-10 items-center justify-center w-10" data-tippy-placement="top" title="List view"> <i
                class="uil-list-ul"></i></a>
    </div>
</div>
...
<div class="my-6 grid lg:grid-cols-4 grid-cols-2 gap-1.5 hover:text-yellow-700 uk-link-reset">
    ...
    <div>
        <div class="bg-red-500 max-w-full lg:h-64 h-40 rounded-md relative overflow-hidden uk-transition-toggle"
             tabindex="0">
            <img src="/storage/{{$post->image}}" class="w-full h-full absolute object-cover inset-0">

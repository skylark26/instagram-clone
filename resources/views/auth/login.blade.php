    ...
    <div>
        <div class="lg:p-12 max-w-md max-w-xl lg:my-0 my-12 mx-auto p-6 space-y-">
            ...
            <form action="{{ route('login.post') }}" method="post">
                ...
                @endif
                <input type="password" name="password" placeholder="***********" class="bg-gray-200 mb-2 shadow-none dark:bg-gray-800"
                       style="border: 1px solid #d3d5d8 !important;">
                ...
                <div class="text-center mt-5 space-x-2">
                    <p class="text-base"> Not registered? <a href="{{ route('register') }}" class=""> Create a account </a>
                    </p>
                </div>
            </form>
        </div>
